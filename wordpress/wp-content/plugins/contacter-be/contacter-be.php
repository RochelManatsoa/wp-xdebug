<?php
/*
Plugin Name: Annaire Téléphonique des Professionnels en Belgique
...
function popup_after_title_in_mobile($content)
{
    ...
    if (is_single() && !empty($GLOBALS['post'])) {
        ...
        if ($GLOBALS['post']->ID == get_the_ID()) {
            ...
            if (metadata_exists('post', get_the_ID(), 'second_featured_image') && (get_post_meta(get_the_ID(), 'second_featured_image', true) !== "" || get_post_meta(get_the_ID(), 'second_featured_image', true) !== "0")) {
                $second_featured_image = wp_get_attachment_image(get_post_meta(get_the_ID(), 'second_featured_image', true), 'full');
            } else {
                $second_featured_image = '<img class="alignnone size-full ls-is-cached lazyloaded" src="https://contacter.be/wp-content/uploads/2022/11/CONTACTERBE2.png" alt="call service"/>';
            }
            ...
            if (metadata_exists('post', get_the_ID(), 'third_featured_image') && (get_post_meta(get_the_ID(), 'third_featured_image', true) !== "" || get_post_meta(get_the_ID(), 'third_featured_image', true) !== "0")) {
                ...
                $third_featured_image = '<img class="alignnone size-full ls-is-cached lazyloaded" src="https://contacter.be/wp-content/uploads/2022/11/contacter-be.png" alt="cartouche" width="350" height="96"/>';
            }
    
    
            if (metadata_exists('post', get_the_ID(), 'number_click_to_call') && get_post_meta(get_the_ID(), 'number_click_to_call', true) !== "" || get_post_meta(get_the_ID(), 'number_click_to_call', true) !== "0") {
                $number_click_to_call = get_post_meta(get_the_ID(), 'number_click_to_call', true);
            } else {
                $number_click_to_call = '090488503';
            }

            if (metadata_exists('post', get_the_ID(), 'activer_image_mobile_en_haut') && get_post_meta(get_the_ID(), 'activer_image_mobile_en_haut', true) !== "" || get_post_meta(get_the_ID(), 'activer_image_mobile_en_haut', true) !== "0") {
            ...
            // echo '<pre>';
            // echo var_dump($activer_image_mobile_en_haut, $activer_image_mobile_en_bas, $number_click_to_call);
            // echo '</pre>';
