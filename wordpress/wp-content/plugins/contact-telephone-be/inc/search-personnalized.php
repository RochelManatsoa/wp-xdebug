        ...
        <main id="main" class="site-main">
            ...
            ?>
                ...
                <figure class="wp-block-image size-full">
                    <a href="tel:090755723">
                        <img width="524" height="524" alt="click to call service" class="alignnone size-full lazyloaded" src="<?= plugins_url('../img/VisuelCTblog.jpg', __FILE__)?>">
                    </a>
                </figure>
            <?php
            // get_search_form();
