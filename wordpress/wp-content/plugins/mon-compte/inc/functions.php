...
function register_script() {
    wp_register_script( 'pfm_js', plugins_url('../js/main.js', __FILE__), ['pfm_bootstrap_js'], '2.5.1' );
...
function enqueue_style(){
    ...
    wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Jost|PT+Sans|Merriweather&display=swap', false );
...
function modify_read_more_link() {
    return '<a class="more-link btn btn-primary" href="' . get_permalink() . '">Lire la suite</a>';
}
