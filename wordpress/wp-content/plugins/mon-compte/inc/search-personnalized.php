        ...
        <main id="main" class="site-main">
            ...
            ?>
                ...
                <figure class="wp-block-image size-full">
                    <a href="tel:0893033342">
                        <img width="768" height="372" src="https://moncompte.org/wp-content/uploads/2022/06/bouton-appelez-moncompte-remedia.jpg" alt="Appeler le service" class="wp-image-68" sizes="(max-width: 767px) 89vw, (max-width: 1000px) 54vw, (max-width: 1071px) 543px, 580px">
                    </a>
                </figure>
            <?php
            //    get_search_form();
