...
function popup_after_title_in_mobile( $content ) {
        ...
        if (is_array($img) || is_object($img)){
            ...
            /**
             * Change cartouche 2022/06/28
             */
            foreach ($img as $value) {
                if(
                    $value->src === 'https://moncompte.org/wp-content/uploads/2022/03/moncompte0893033342.jpg' || 
                    $value->src === 'https://moncompte.org/wp-content/uploads/2022/03/moncompte0893033342-1.jpg' 
                        
                ){
                    $value->setAttribute('src', 'https://moncompte.org/wp-content/uploads/2022/06/bouton-appelez-moncompte-remedia.jpg');
                    if(isset($value->srcset)){
                        $value->setAttribute('srcset', str_replace('https://moncompte.org/wp-content/uploads/2022/03/moncompte0893033342-1', 'https://moncompte.org/wp-content/uploads/2022/06/bouton-appelez-moncompte-remedia', $value->srcset));
                        $value->setAttribute('srcset', str_replace('https://moncompte.org/wp-content/uploads/2022/03/moncompte0893033342', 'https://moncompte.org/wp-content/uploads/2022/06/bouton-appelez-moncompte-remedia', $value->srcset));
                    }
                }
        ...
        if( is_single() && ! empty( $GLOBALS['post'] ) ) {
            ...
            if ( $GLOBALS['post']->ID == get_the_ID() ) {
                ...
                if (metadata_exists('post', get_the_ID(), 'second_featured_image') && get_post_meta(get_the_ID(), 'second_featured_image', true) !== "") {
                    ...
                    $second_featured_image = '<img loading="lazy" class="alignnone size-medium ls-is-cached lazyloaded" src="https://moncompte.org/wp-content/uploads/2022/06/bouton-appelez-moncompte-remedia.jpg" alt="call service" width="300" height="145" />';
                }
                ...
                if (metadata_exists('post', get_the_ID(), 'third_featured_image') && get_post_meta(get_the_ID(), 'third_featured_image', true) !== "") {
                    ...
                    $third_featured_image = '<img class="alignnone size-full ls-is-cached lazyloaded" src="https://moncompte.org/wp-content/uploads/2022/10/MONCOMPTE.png" alt="cartouche" width="425" height="71"/>';
                }
                ...
                if (metadata_exists('post', get_the_ID(), 'number_click_to_call') && get_post_meta(get_the_ID(), 'number_click_to_call', true) !== "") {
                    ...
                    $number_click_to_call = '0890211833';
                }
        ...
        //             $custom_content .= '<div class="textwidget-slide">';
        //                 $custom_content .= '<figure class="wp-block-image">';
        //                     $custom_content .= '<a href="tel:0890211833">';
        //                         $custom_content .= '<img loading="lazy" class="alignnone size-medium ls-is-cached lazyloaded" src="https://moncompte.org/wp-content/uploads/2022/06/bouton-appelez-moncompte-remedia.jpg" alt="call service" width="300" height="145" />';
        //                     $custom_content .= '</a>';
        //                 $custom_content .= '</figure>';
        //             $custom_content .= '</div>';     
        //         $custom_content .= '</div>';
        ...
        //     $custom_content .= '<a href="tel:0890211833">';
        //     $custom_content .= '<img class="alignnone size-full ls-is-cached lazyloaded" src="https://moncompte.org/wp-content/uploads/2022/10/MONCOMPTE.png" alt="cartouche" width="425" height="71"/>';
        //     $custom_content .= '</a>';
        //     $custom_content .= '</figure>';
        //         $custom_content .= $html;
