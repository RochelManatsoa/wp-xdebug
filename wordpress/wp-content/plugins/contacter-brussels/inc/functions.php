...
function register_script() {
    wp_register_script( 'rochel_js', plugins_url('../js/main.js', __FILE__), [], '2.5.1' );
    wp_register_style( 'rochel_css', plugins_url('../css/style.css', __FILE__), false, '1.3.0', 'all');
}
...
function enqueue_style(){
    ...
    wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Poppins|Open+Sans|Roboto+Slab|Lato&display=swap', false );
    wp_enqueue_script('rochel_js');
    wp_enqueue_style( 'rochel_css' );
}
