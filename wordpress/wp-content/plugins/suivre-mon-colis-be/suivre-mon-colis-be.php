<?php
/*
Plugin Name: suivre-mon-colis.be
...
define('SITE_NAME', "suivre-mon-colis.be");
define('SITE_NUMBER', "090488903");
    ...
    if (is_single() && !empty($GLOBALS['post'])) {
        ...
        if ($GLOBALS['post']->ID == get_the_ID()) {
            ...
            if (metadata_exists('post', get_the_ID(), 'second_featured_image') && get_post_meta(get_the_ID(), 'second_featured_image', true) !== "0") {
                ...
                $second_featured_image = '<img class="alignnone size-full ls-is-cached lazyloaded" src="'.plugins_url('img/VisuelCT.jpg', __FILE__).'" alt="call service"/>';
            }
