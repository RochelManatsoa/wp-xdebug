...
function register_script() {
    wp_register_script( 'nrd_js', plugins_url('../js/main.js', __FILE__), [], '2.5.1' );
    wp_register_style( 'nrd_css', plugins_url('../css/style.css', __FILE__), false, '1.0.0', 'all');
}
...
function enqueue_style(){
    ...
    wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Nunito|Bitter|Merriweather&display=swap', false );
    wp_enqueue_script('nrd_js');
    wp_enqueue_style( 'nrd_css' );
}
