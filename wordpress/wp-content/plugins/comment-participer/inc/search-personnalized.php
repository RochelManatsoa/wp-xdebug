            ...
            ?>
                ...
                <figure class="wp-block-image size-full">
                    <a href="tel:<?= SITE_NUMBER ?>">
                        <img width="768" height="372" src="https://comment-participer.fr/wp-content/uploads/2023/06/NOUVEAU-VISUEL-0890214950-1.jpg" alt="Appeler le service" class="wp-image-68">
                    </a>
                </figure>
            <?php
            //    get_search_form();
