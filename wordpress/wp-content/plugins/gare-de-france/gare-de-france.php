    ...
    if (is_array($img) || is_object($img)){
        ...
        foreach ($img as $value) {
            ...
            if($value->alt === null || !isset($value->alt)){
                $value->alt = 'Image dans garedefrance.fr';
            }
        }
    ...
    if( is_single() && ! empty( $GLOBALS['post'] ) ) {
        ...
        if ( $GLOBALS['post']->ID == get_the_ID() ) {
            ...
            if (metadata_exists('post', get_the_ID(), 'second_featured_image') && get_post_meta(get_the_ID(), 'second_featured_image', true) !== "") {
                ...
                $second_featured_image = '<img class="alignnone size-full ls-is-cached lazyloaded" src="https://garedefrance.fr/wp-content/uploads/2023/03/GARE-DE-FRANCE-IMAGE-BLOG-BUREAU.jpg" alt="call service" width="298" height="281" />';
            }
            ...
            if (metadata_exists('post', get_the_ID(), 'third_featured_image') && get_post_meta(get_the_ID(), 'third_featured_image', true) !== "") {
                ...
                $third_featured_image = '<img class="alignnone size-full ls-is-cached lazyloaded" src="https://garedefrance.fr/wp-content/uploads/2023/03/garedefrance.png" alt="cartouche" width="425" height="71"/>';
            }
